...
class SoftwareSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Software::create([
            ...
            'requisitos' => 'Requisitos minimos para configurações bronze:  CPU: Intel Core i5-4430 / AMD FX-6300, GPU: NVIDIA GeForce GTX 960 2GB / AMD Radeon R7 370 2GB, RAM: 8 GB. Requisitos minimos para configurações prata: CPU: Intel Core i5-6600K / AMD Ryzen 5 1600, GPU: NVIDIA GeForce GTX 1060 3GB / AMD Radeon RX 580 4GB, RAM: 16 GB. Requisitos minimos para configurações ouro: CPU: Intel Core i7-8700K / AMD Ryzen 7 2700X, GPU: NVIDIA GeForce GTX 1080 Ti 4GB / AMD Radeon RX Vega 64 4GB ,RAM: 16 GB.',
        ]);
        ...
        Software::create([
            ...
            'requisitos' => 'Requisitos minimos para configurações bronze: CPU: Intel Core i5-2500K / AMD FX-4300, GPU: NVIDIA GeForce GTX 960 / AMD Radeon R7 370, RAM: 8 GB. Requisitos minimos para configurações prata: CPU: Intel Core i5-6600K / AMD Ryzen 5 1600, GPU: NVIDIA GeForce GTX 1060 / AMD Radeon RX 580, RAM: 16 GB. Requisitos minimos para configurações ouro: CPU: Intel Core i7-8700K / AMD Ryzen 7 2700X, GPU: NVIDIA GeForce GTX 1080 Ti / AMD Radeon RX Vega 64, RAM: 16 GB',
        ]);
        ...
        Software::create([
            ...
            'requisitos' => 'Requisitos minimos para configurações bronze: CPU: Intel Core i5-4460 / AMD FX-8120, GPU: NVIDIA GeForce GTX 1050 / AMD Radeon R7 250X, RAM: 8 GB. Requisitos minimos para configurações prata: CPU: Intel Core i7-8700 / AMD Ryzen 5 3600, GPU: NVIDIA GeForce GTX 1660 / AMD Radeon RX 580, RAM: 16 GB. Requisitos minimos para configurações ouro: CPU: Intel Core i9-9900K / AMD Ryzen 7 3700X, GPU: NVIDIA GeForce RTX 2070 / AMD Radeon RX 5700 XT, RAM: 32 GB.',
        ]);
